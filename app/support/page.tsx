...
export default function Support() {
  return <Subpage title="対応環境・サポート">
    ...
    <section className="document-section" id="contact"><h2>お問い合わせ</h2><p>アプリをお使いの方は「設定」→「フィードバック」からお問い合わせください。アプリを利用できない場合は、開発者のGitHubプロフィールに記載された連絡先をご確認ください。</p><a className="text-link" href="https://github.com/mitsuya0077">開発者のGitHubを見る →</a></section>
  </Subpage>;
}
